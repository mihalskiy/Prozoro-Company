...
if (!$Module or $Page == 'test' and $Module == 'create' or $Page == 'test' and $Module == 'main') include('module/all_table/allTable.php');
//else if ($Module == 'material') {
include('module/all_table/create.php');
//include('module/all_table/db.php');
include('module/all_table/delete.php');
include('module/all_table/fetch_single.php');
include('module/all_table/fetch.php');
include('module/all_table/function.php');
include('module/all_table/insert.php');
include('module/all_table/update.php');
}
...
function Menu() {
  ...
  if ($_SESSION['USER_LOGIN_IN'] != 1) $Menu = '<ul class="nav navbar-nav navbar-right"><li class="nav-item"><a class="nav-link" href="/register"><span class="glyphicon glyphicon-log-in"></span> Реєстрація</a></li><li class="nav-item"><a class="nav-link" href="/login"><span class="glyphicon glyphicon-user"></span> Вхід</a></li><li class="nav-item"><a class="nav-link" href="/restore">Відновити пароль</a></li></ul>';
	else  $Menu = '<div class="collapse navbar-collapse" id="myNavbar"><ul class="nav navbar-nav"><li><a href="/loads"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Файли</a></li><li><a href="/all"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Уся таблиця</a></li><li><a href="/chat"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span> Чат</a></li></ul><ul class="nav navbar-nav navbar-right"><li><a href="#"><span class="glyphicon glyphicon-bell" aria-hidden="true"></span> Повідомлення</a></li><li class="dropdown"><a href="#" class="dropdown-toggle navbar-brand " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img alt="Brand" class="foto" src="/resource/avatar/'.$Avatar.'.jpg""></a><ul class="dropdown-menu"><li><a href="/profile">Мій профіль</a></li><li><li role="separator" class="divider"></li><li><a href="/account/logout">Вийти</a></li></ul>';
