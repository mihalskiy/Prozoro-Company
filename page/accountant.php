...
$col = array(); 
$col["title"] = "Дата передачі банківської гарантії тендерної пропозиції"; // caption of column 
$col["name"] = "accountantDateTransmission"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
...
$col = array(); 
$col["title"] = "Банківська гарантія для заключення договору"; // caption of column 
$col["name"] = "accountantBankGarant"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["editable"] = true; 
$cols[] = $col; 

$col = array(); 
$col["title"] = "Дата закриття банківської гарантії тендерної пропозиції"; // caption of column 
$col["name"] = "accountantDateBankGarante"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
$col["editable"] = true; 
$cols[] = $col; 
